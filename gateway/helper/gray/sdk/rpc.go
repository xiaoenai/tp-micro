...
func IsGray(args *types.IsGrayArgs, setting ...socket.PacketSetting) (*types.IsGrayResult, *tp.Rerror) {
	...
	rerr := _formalClient.Pull("/gray/is_gray", args, reply, setting...).Rerror()
	return reply, rerr
}
...
func Get(args *types.GetArgs, setting ...socket.PacketSetting) (*types.GrayMatch, *tp.Rerror) {
	...
	rerr := _formalClient.Pull("/gray/get", args, reply, setting...).Rerror()
	return reply, rerr
}
...
func Delete(args *types.DeleteArgs, setting ...socket.PacketSetting) (*struct{}, *tp.Rerror) {
	reply := new(struct{})
	rerr := _formalClient.Pull("/gray/delete", args, reply, setting...).Rerror()
	return reply, rerr
}
...
func Set(args *types.SetArgs, setting ...socket.PacketSetting) (*struct{}, *tp.Rerror) {
	reply := new(struct{})
	rerr := _formalClient.Pull("/gray/set", args, reply, setting...).Rerror()
	return reply, rerr
}
